 ...
 * Constraints: min_number_of_rows <= number_of_rows <= max_number_of_rows
 *              min_number_of_columns <= number_of_columns <= max_number_of_columns
 *              min_number_of_tokens <= winning_number_of_tokens <= max_number_of_tokens
 */
